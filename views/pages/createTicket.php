        ...
        <fieldset class="py-4 px-4">
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" id="nombre" name="nombre" maxlength="100" autocomplete="name" required autofocus value="">
            </div>
            ...
            <div class="col-md-6">
              ...
              <input type="text"
                class="form-control" id="extension" name="extension" maxlength="4" inputmode="numeric" pattern="\d{3,4}" aria-describedby="ayudaExtension" required value="">
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6">
              ...
              <select class="form-select"
                ...
                <option value="">Priorid_1</option>
              </select>
            </div>

            <div class="col-12">
              <label for="asunto" class="form-label">Asunto *</label>
              <input type="text" class="form-control" id="asunto" name="asunto" maxlength="100" autocomplete="asunto" required value="">
            </div>
